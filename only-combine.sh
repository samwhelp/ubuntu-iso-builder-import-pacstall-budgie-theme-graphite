...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/iso-profile
"
echo
