...
> [ubuntu-iso-builder-import-pacstall-budgie-theme-graphite](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/)
...
| `=` |
| [ubuntu-iso-builder-include-pacstall-budgie-theme-graphite](https://github.com/samwhelp/ubuntu-iso-builder-include-pacstall-budgie-theme-graphite) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-graphite](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-graphite`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-graphite
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-graphite/iso-profile/dist`
